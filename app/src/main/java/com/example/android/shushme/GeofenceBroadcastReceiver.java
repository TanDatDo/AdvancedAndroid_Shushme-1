...
// TODO (4.4) Create a GeofenceBroadcastReceiver class that extends BroadcastReceiver and override
...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent){
        ...
        // TODO (5.4) Use GeofencingEvent.fromIntent to retrieve the GeofencingEvent that caused the transition
        ...
        // TODO (5.6) Show a notification to alert the user that the ringer mode has changed.
        // Feel free to create a helper method (sendNotification)
        // Get a notification builder
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context);

        // TODO (5.5) Call getGeofenceTransition to get the transition type and use AudioManager to set the
